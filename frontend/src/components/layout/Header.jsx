...
import { Search, Bell, Shield, Building2, MapPin } from 'lucide-react';
    ...
    <header className="h-16 bg-slate-900 border-b border-slate-800 px-6 flex items-center justify-between sticky top-0 z-30 shadow-sm text-slate-200">
      ...
      <div className="relative w-96">
        ...
        <input
          ...
          className="w-full bg-slate-800/80 text-xs text-slate-200 pl-9 pr-4 py-2 rounded-md border border-slate-700/80 focus:outline-none focus:border-slate-500 placeholder-slate-400"
        />
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-slate-800/90 px-3 py-1.5 rounded border border-slate-700/80 text-xs">
        ...
        <div className="flex items-center gap-1.5 text-xs text-slate-400 font-medium pl-2 border-l border-slate-800">
