    ...
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 max-w-7xl mx-auto w-full overflow-x-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-3">
        ...
        <button
          ...
          className="bg-slate-900 text-white hover:bg-slate-800 text-xs font-semibold px-3 py-2 rounded flex items-center gap-1.5 transition shadow-sm cursor-pointer"
        >
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-100 text-slate-600 text-[11px] uppercase tracking-wider font-bold border-b border-slate-200">
                  ...
                  >
                    <span className="flex items-center gap-1">
                      Sanction <ArrowUpDown className="w-3 h-3 text-slate-400" />
                    </span>
                  </th>
                  <th
                    className="py-2.5 px-3 cursor-pointer select-none"
                  ...
                  <tr key={p.id} className="hover:bg-slate-50 transition">
                    ...
                    <td className="py-3 px-3 text-right">
                      <button
                        ...
                        className="bg-slate-900 text-white text-[11px] font-semibold px-2.5 py-1 rounded hover:bg-slate-800 inline-flex items-center gap-0.5 cursor-pointer"
                      >
