...
import { fetchDashboardStats, fetchGeoMapData } from "@/lib/api";
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-5 shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100 px-3 py-1.5 rounded border border-slate-200 cursor-pointer"
          >
            View Full Queue →
          </button>
        </div>
                ...
                >
                  ...
                  <td className="py-3 px-3 text-right">
                    <button
                      ...
                      className="bg-slate-900 text-white text-[11px] font-semibold px-2.5 py-1 rounded hover:bg-slate-800 inline-flex items-center gap-1 cursor-pointer"
                    >
