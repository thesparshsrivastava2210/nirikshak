...
import { fetchProjects, fetchGeoMapData } from "@/lib/api";
    ...
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 max-w-7xl mx-auto w-full overflow-x-hidden">
      ...
      <div className="bg-white p-3 sm:p-4 rounded-lg border border-slate-200 shadow-sm flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 text-xs">
        ...
        <button
          ...
          className="sm:ml-auto text-xs text-slate-500 hover:text-slate-900 underline font-medium cursor-pointer"
        >
          Reset Filters
        </button>
      </div>
                ...
                <tr key={p.id} className="hover:bg-slate-50 transition">
                  ...
                  <td className="py-2.5 px-3 text-right">
                    <button
                      ...
                      className="text-slate-800 hover:text-slate-950 font-bold hover:underline inline-flex items-center gap-0.5 cursor-pointer"
                    >
